...
from PyQt5.QtWidgets import QLabel,QApplication , QVBoxLayout, QFormLayout, QLineEdit, QSlider,  QHBoxLayout, QWidget, QPushButton, QRadioButton, QFontDialog, QColorDialog
import logging
...
class MarqueeLabel(QLabel):
    def __init__(self, parent=None):
        ...
        self.setGeometry(QtCore.QRect(0, 15, 41, 22))
